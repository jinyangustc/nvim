if vim.g.neovide then
  vim.o.guifont = 'DepartureMono Nerd Font:h16'
  vim.g.neovide_cursor_animation_length = 0
  vim.g.neovide_scroll_animation_length = 0
end

if vim.g.gui_vimr then vim.o.guifont = 'DepartureMono Nerd Font:h16' end
...
-- keybinds for copy/paste from system clipboard
vim.keymap.set({ 'n', 'v' }, '<leader>y', '"+y', { desc = 'Copy to system clipboard' })
vim.keymap.set({ 'n', 'v' }, '<leader>yy', '"+yy', { desc = 'Copy line to system clipboard' })
vim.keymap.set({ 'n', 'v' }, '<leader>Y', '"+yg_', { desc = 'Copy to end of the line to system clipboard' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sl', builtin.loclist, { desc = '[S]earch [L]ocation Lists' })
  ...
  { -- Autocompletion
    ...
    dependencies = {
      -- Snippet Engine
      -- Already configured in lua/custom/plugins/luasnip.lua
      'L3MON4D3/LuaSnip',
    },
    ---@module 'blink.cmp'
