...
require('lazy').setup({
    ...
    config = function()
      ...
      local servers = {
        ...
        lua_ls = {
          ...
          settings = {
            Lua = {
              -- See: https://www.reddit.com/r/neovim/comments/pla7bv/since_everyone_is_getting_more_familiar_with_lua/
              completion = {
                callSnippet = 'Replace',
              },
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'python', 'rust', 'markdown_inline', 'query', 'vim', 'vimdoc' },
